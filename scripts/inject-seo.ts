...
const PAGE_DESCRIPTIONS: Record<string, PageMeta> = {
  'index.html': { description: 'DSBJ - Le Design Système officiel de la République du Bénin. 53 composants HTML/CSS/JS accessibles pour construire des interfaces numériques gouvernementales.', priority: '1.0' },
  ...
  'composants/index.html': { description: 'Bibliothèque de 53 composants HTML/CSS du DSBJ : navigation, formulaires, contenu, interactifs et réglementaire.', priority: '0.8' },
  ...
  'composants/drawer.html': { description: 'Composant Tiroir du DSBJ : panneau latéral glissant avec overlay et focus piégé.', priority: '0.5' },
