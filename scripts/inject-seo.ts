...
const PAGE_DESCRIPTIONS: Record<string, PageMeta> = {
  'index.html': { description: 'DSBJ - Le Design Système officiel de la République du Bénin. 52 composants HTML/CSS/JS accessibles pour construire des interfaces numériques gouvernementales.', priority: '1.0' },
  ...
  'composants/index.html': { description: 'Bibliothèque de 52 composants HTML/CSS du DSBJ : navigation, formulaires, contenu, interactifs et réglementaire.', priority: '0.8' },
