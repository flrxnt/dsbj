...
const { t } = useI18n({
  messages: {
    fr: {
      ...
      'cls-disabled': 'État désactivé (opacité réduite, interactions bloquées).',
    ...
    en: {
      title: 'Rich Editor',
      desc:
        'The WYSIWYG rich editor allows rich-text input and formatting directly in the browser. It provides a full toolbar for formatting, media insertion, tables, code blocks, and more.',
...
const propsRows = computed(() => [
  ...
  { name: 'bj-rich-editor__toolbar-group', description: t('cls-toolbar-group') },
  { name: 'bj-rich-editor__toolbar-btn', description: t('cls-toolbar-btn') },
  { name: 'bj-rich-editor__toolbar-btn--active', description: t('cls-toolbar-btn-active') },
...
<template>
    ...
    <DocsPreview>
      <div class="bj-rich-editor" style="max-width: 48rem">
        <div class="bj-rich-editor__toolbar" role="toolbar" aria-label="Éditeur">
          ...
          <div class="bj-rich-editor__toolbar-group">
            <button type="button" class="bj-rich-editor__toolbar-btn" aria-label="Retrait +"><i class="ri-indent-increase" aria-hidden="true"></i></button>
            <button type="button" class="bj-rich-editor__toolbar-btn" aria-label="Retrait -"><i class="ri-indent-decrease" aria-hidden="true"></i></button>
          </div>
          <div class="bj-rich-editor__toolbar-separator" aria-hidden="true" />
          <div class="bj-rich-editor__toolbar-group">
            <button type="button" class="bj-rich-editor__toolbar-btn" aria-label="Gauche"><i class="ri-align-left" aria-hidden="true"></i></button>
            <button type="button" class="bj-rich-editor__toolbar-btn" aria-label="Centre"><i class="ri-align-center" aria-hidden="true"></i></button>
            <button type="button" class="bj-rich-editor__toolbar-btn" aria-label="Droite"><i class="ri-align-right" aria-hidden="true"></i></button>
            <button type="button" class="bj-rich-editor__toolbar-btn" aria-label="Justifié"><i class="ri-align-justify" aria-hidden="true"></i></button>
          </div>
          <div class="bj-rich-editor__toolbar-separator" aria-hidden="true" />
          <div class="bj-rich-editor__toolbar-group">
            <button type="button" class="bj-rich-editor__toolbar-btn" aria-label="Lien"><i class="ri-link" aria-hidden="true"></i></button>
            ...
            <button type="button" class="bj-rich-editor__toolbar-btn" aria-label="Image"><i class="ri-image-line" aria-hidden="true"></i></button>
            <button type="button" class="bj-rich-editor__toolbar-btn" aria-label="Vidéo"><i class="ri-video-line" aria-hidden="true"></i></button>
            <button type="button" class="bj-rich-editor__toolbar-btn" aria-label="Tableau"><i class="ri-table-line" aria-hidden="true"></i></button>
          </div>
          <div class="bj-rich-editor__toolbar-separator" aria-hidden="true" />
          <div class="bj-rich-editor__toolbar-group">
            ...
            <button type="button" class="bj-rich-editor__toolbar-btn" aria-label="Code"><i class="ri-code-line" aria-hidden="true"></i></button>
  ...
  <DocsSection id="toolbar-editor" :title="t('section-toolbar')">
    <DocsPreview style="display: flex; flex-wrap: wrap; gap: var(--bj-spacing-3v); align-items: center;">
      <button type="button" class="bj-rich-editor__toolbar-btn" aria-label="Normal"><i class="ri-bold" aria-hidden="true"></i></button>
      <button type="button" class="bj-rich-editor__toolbar-btn bj-rich-editor__toolbar-btn--active" aria-label="Actif"><i class="ri-bold" aria-hidden="true"></i></button>
    </DocsPreview>
  ...
  <DocsSection id="disabled-editor" :title="t('section-disabled')">
    <DocsPreview>
      <div class="bj-rich-editor bj-rich-editor--disabled" style="max-width: 40rem">
        <div class="bj-rich-editor__toolbar" role="toolbar" aria-label="Éditeur">
          <div class="bj-rich-editor__toolbar-group">
            <button type="button" class="bj-rich-editor__toolbar-btn" aria-label="Gras"><i class="ri-bold" aria-hidden="true"></i></button>
            <button type="button" class="bj-rich-editor__toolbar-btn" aria-label="Italique"><i class="ri-italic" aria-hidden="true"></i></button>
        ...
        <div class="bj-rich-editor__content" contenteditable="false" role="textbox" aria-multiline="true" style="min-height: 4rem">
          Contenu en lecture seule
        </div>
      </div>
    </DocsPreview>
  ...
  <DocsSection id="prefilled-editor" :title="t('section-prefilled')">
    <DocsPreview>
      <div class="bj-rich-editor" style="max-width: 40rem">
        ...
        <div class="bj-rich-editor__content" contenteditable="true" role="textbox" aria-multiline="true" style="min-height: 8rem">
          <h2>Titre d'exemple</h2>
          <p>Un paragraphe avec du texte <strong>gras</strong> et <em>italique</em>.</p>
          <ul>
            <li>Premier élément</li>
